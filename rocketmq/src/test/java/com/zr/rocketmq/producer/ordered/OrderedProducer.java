package com.zr.rocketmq.producer.ordered;
...
public class OrderedProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            String body = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"))
                + " Hello RocketMQ" + orderList.get(i);

            Message msg = new Message("MyOrderedTopic", tags[i % tags.length], "KEY" + i, body.getBytes());
